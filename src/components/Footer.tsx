    ...
    <footer className="bg-gray-800 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <img src={logo} alt="Escola Villa Happy" className="h-20 mb-4" />
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/admissao" className="text-gray-300 hover:text-white">Admissão</a></li>
              <li><a href="/sobre" className="text-gray-300 hover:text-white">Sobre Nós</a></li>
              <li><a href="/curriculo" className="text-gray-300 hover:text-white">Currículo</a></li>
              <li><a href="/vida-escolar" className="text-gray-300 hover:text-white">Vida Escolar</a></li>
              <li><a href="/fotos" className="text-gray-300 hover:text-white">Fotos</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                <svg className="h-6 w-6 mr-2 text-villa-orange" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">(11) 4612-2918</span>
              </li>
              <li className="flex items-center">
                <svg className="h-6 w-6 mr-2 text-villa-orange" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-300">secretaria@escolavillahappy.com.br</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <h3 className="text-xl font-bold mb-4 mt-6">Newsletter</h3>
            <form className="flex">
              <input 
                type="email" 
              ...
              <button 
                type="submit" 
                className="bg-villa-orange px-4 py-2 rounded-r-lg hover:bg-opacity-90 transition-colors"
              >
        ...
        <div className="border-t border-gray-700 mt-10 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Escola Villa Happy. Todos os direitos reservados.
            </p>
