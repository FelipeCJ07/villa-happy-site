...
const Register: React.FC = () => {
  ...
  const canCreateUsers = userData?.role === 'admin';
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
            <span className="block sm:inline">Você não tem permissão para criar novos usuários.</span>
          </div>
        </div>
      </div>
    );
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-villa-orange focus:border-villa-orange focus:z-10 sm:text-sm"
                placeholder="Email"
                value={email}
